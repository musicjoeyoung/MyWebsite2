    ...
    return (
        <div className="media" id="media">
            ...
            <div className="media__grid">
                ...
                <div className="media__item">
                    {/* <img src="https://res.cloudinary.com/dfbuwtl5q/image/upload/v1763043688/Joe-Young-Wash-Your-Hands_sqchpz.webp" alt="Wash Your Hands Single Cover" /> */}
                    <TwitterTweetEmbed tweetId="1234969300529745921" />;
                    <iframe width="100%" height="166" scrolling="no" frameBorder="no" allow="autoplay" src="https://w.soundcloud.com/player/?url=https%3A//api.soundcloud.com/tracks/soundcloud%253Atracks%253A784583071&color=%23ff5500&auto_play=false&hide_related=false&show_comments=true&show_user=true&show_reposts=false&show_teaser=true"></iframe><div style={{ fontSize: '10px', color: '#cccccc', lineBreak: 'anywhere', wordBreak: 'normal', overflow: 'hidden', whiteSpace: 'nowrap', textOverflow: 'ellipsis', fontFamily: 'Interstate,Lucida Grande,Lucida Sans Unicode,Lucida Sans,Garuda,Verdana,Tahoma,sans-serif', fontWeight: 100 }}><a href="https://soundcloud.com/musicjoeyoung" title="musicjoeyoung" target="_blank" style={{ color: '#cccccc', textDecoration: 'none' }}>musicjoeyoung</a> · <a href="https://soundcloud.com/musicjoeyoung/wash-your-hands" title="Wash Your Hands!" target="_blank" style={{ color: '#cccccc', textDecoration: 'none' }}>Wash Your Hands!</a></div>
                </div>
            </div>
